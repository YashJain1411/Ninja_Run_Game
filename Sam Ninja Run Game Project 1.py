...
def gameloop():
    ...
    #collision
        ...
        if obstacle_x +400< player_x + 50 < obstacle_x + 470 and obstacle_y < player_y+50 < obstacle_y+50:
            ...
            game = False
            gameover = True
        if obstacle_x +600< player_x + 50 < obstacle_x + 670 and obstacle_y < player_y+50 < obstacle_y+50:
            bg_velocity = 0
            walkpoint = 0
            game = False
            gameover = True
        if obstacle_x +1000< player_x + 50 < obstacle_x + 1070 and obstacle_y < player_y+50 < obstacle_y+50:
            bg_velocity = 0
            walkpoint = 0
            game = False
            gameover = True
    ...
    #obstacle repetition
        ...
        screen.blit(obstacle2,[obstacle_x + 600, obstacle_y-40 ])
        screen.blit(obstacle3,[obstacle_x + 1000, obstacle_y -75])
